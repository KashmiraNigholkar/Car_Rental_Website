...
const Testimonial = () => {
    const testimonials = [
        {  name: "Emma Rodriguez", 
           ...
           testimonial: "CarRental mademytrip so much easier. The car was delivered right to my door , and the customer service was fantastic!."
         },

          {  name: "Ava JohnSon", 
           location: "Sdney,Australia",
           image: assets.testimonial_image_1,  
           testimonial: "I hightly recommend CarRental  ! Their fleet is amaizing , and I always feel like I'm getting the best deal with excellent service ."
         },
    ];
